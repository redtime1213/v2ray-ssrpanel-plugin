...
```
curl -L -s https://raw.githubusercontent.com/yulewang/v2ray-ssrpanel-plugin/master/install-release.sh | sudo bash
```

#### Uninstall

```
curl -L -s https://raw.githubusercontent.com/yulewang/v2ray-ssrpanel-plugin/master/uninstall.sh | sudo bash
```
