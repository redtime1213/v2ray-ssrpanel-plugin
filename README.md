...
```
curl -L -s https://raw.githubusercontent.com/redtime1213/v2ray-ssrpanel-plugin/master/install-release.sh | sudo bash
```

#### Uninstall

```
curl -L -s https://raw.githubusercontent.com/redtime1213/v2ray-ssrpanel-plugin/master/uninstall.sh | sudo bash
```
