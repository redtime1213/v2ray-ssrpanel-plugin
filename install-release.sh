...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/redtime1213/v2ray-ssrpanel-plugin/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/redtime1213/v2ray-ssrpanel-plugin/releases/latest"
